...
<head>
    ...
    <link rel="stylesheet" href="appli2/app2.css">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  if (empty($_POST["size"])) {
    $errors['size'] = "Veuillez remplir tous les champs.";
  } else {
    ...
    if (($c1==$c3) || ($c2==$c3) || ($c1==$c2)){
        $errors['c'] = "Deux couleurs ne peuvent pas être similaires.";
    }
  }
    ...
    <div class="content">
        ...
        <div class="form">
            <form class="form1" method="POST">
                ...
                <div class="form-content">
                    <div class="form-title"><label for="c3">Select C3</label></div>
                    <div class="form-icon icon5"><img src="icone2_3.png" alt=""></div>
                    <div class="form-input"><select class="select select4" name="c3">
                        <?php foreach ($colors as $color => $symbol) {
                            ?>
                            <option <?php if($color==$c3){echo "selected";}?>
                             value="<?=$color?>"   >
                             <?=$color?> 
                            </option>
                        <?php } ?>
